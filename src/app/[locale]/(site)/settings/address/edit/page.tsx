...
export default function AddressEditPage() {
  ...
  const [postcode, setPostcode] = useState("15000"); // Mocked
  const [address, setAddress] = useState("경기 시흥시 능곡중앙로 34 (휴먼시아)");
      ...
      <div className="w-full max-w-[960px] bg-white relative shadow-sm flex flex-col">
        ...
        <header className="sticky top-0 z-50 bg-[#f8f9fa] border-b border-gray-100">
          <div className="flex items-center px-5 h-[60px]">
            <h1 className="text-[18px] font-bold text-black">배송지 수정</h1>
          </div>
        </header>
            ...
            <div className="flex flex-col gap-2.5">
              ...
              <div className="relative">
                <select
                  ...
                  className="border border-gray-200 rounded-[4px] px-3.5 py-3.5 text-[14px] w-full appearance-none focus:outline-none focus:border-black text-gray-500 bg-white"
                >
