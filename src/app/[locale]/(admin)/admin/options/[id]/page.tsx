...
export default function EditCommonlyUsedOptionPage() {
    ...
    const [manageName, setManageName] = useState("N_SIZE5");
    ...
    const [options, setOptions] = useState([
        { id: 1, name: "SIZE", values: ["095", "100", "105", "110"] }
    ]);
    ...
    return (
        <div className="p-6 space-y-6 bg-white min-h-screen font-sans text-sm pb-24">
            ...
            <div className="flex items-center gap-2 text-xs text-gray-500 mb-4">
                ...
                <span>상품 관리</span>
                <span>&gt;</span>
                <span className="font-bold text-gray-700">자주쓰는 옵션 수정</span>
            </div>

            {/* Header */}
            <div className="flex items-center justify-between pb-4 border-b border-gray-300">
                <h1 className="text-2xl font-bold text-gray-900">자주쓰는 옵션 수정</h1>
            ...
            <div>
                <div className="flex items-center gap-1 mb-2">
                    <h2 className="text-lg font-bold text-gray-800">자주쓰는 옵션 수정</h2>
                ...
                <div className="border-t-2 border-gray-800">
                    ...
                    <div className="flex border-b border-gray-200">
                        ...
                        <div className="flex-1 p-3 flex items-center gap-6">
                            ...
                            <button 
                                type="button"
                                className="h-7 text-xs bg-[#aeaeae] text-white rounded-sm px-3 ml-2 flex items-center justify-center transition-none hover:bg-[#aeaeae] active:bg-[#aeaeae]"
                    ...
                    <div className="flex border-b border-gray-200">
                        ...
                        <div className="flex-1 p-3">
                            <Select value={optionCount} onValueChange={setOptionCount}>
                                <SelectTrigger className="w-[120px] h-8 text-xs rounded-sm border-gray-300">
                                    <SelectValue placeholder="1개" />
                                </SelectTrigger>
                                <SelectContent>
                                    {[1, 2, 3, 4, 5].map(num => (
                                            ...
                                            {opt.values.map((val, idx) => (
                                                <div key={idx} className="flex gap-1 items-center">
                                                    ...
                                                    {idx === 0 ? (
                                                        <Button 
                                                            variant="outline" 
                                                            className="h-8 h-8 px-2 text-xs border-gray-300 text-gray-600 rounded-sm"
                                                        ...
                                                        <Button 
                                                            variant="outline" 
                                                            className="h-8 h-8 px-2 text-xs border-gray-300 text-gray-400 rounded-sm"
