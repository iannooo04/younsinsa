  ...
  return (
    <div className="p-6 bg-white min-h-screen font-sans text-xs pb-24 relative">
      <div className="flex items-center justify-between pb-4 border-b border-gray-400 mb-6">
        <h1 className="text-2xl font-bold text-gray-900">입금대기 리스트</h1>
      </div>
                    ...
                    <div className="flex items-center gap-0.5 ml-1">
                        ...
                        <Button onClick={() => { 
                         ...
                         <Button onClick={() => { 
                            ...
                            setStartDate(format(d, "yyyy-MM-dd")); 
                            setEndDate(format(new Date(), "yyyy-MM-dd")); 
                        }} variant="default" size="sm" className="h-7 px-2 text-[11px] bg-white text-gray-600 rounded-sm border-gray-300 hover:bg-gray-50">1년</Button>
                    </div>
                </div>
            </div>
          ...
          <table className="w-full text-xs text-center border-collapse table-fixed min-w-[1800px]">
              ...
              <thead className="bg-[#BDBDBD] text-white font-normal">
                  <tr className="h-10">
                      ...
                      <th className="border-r border-[#CDCDCD]">입금계좌</th>
              ...
              <tbody className="text-gray-600 bg-white">
                  {loading ? (
                    <tr>
                        <td colSpan={16} className="py-10 border-b border-gray-200 text-center text-sm">로딩중...</td>
                    </tr>
                  ) : orders.length === 0 ? (
                      <tr>
                          <td colSpan={16} className="py-10 border-b border-gray-200 text-center text-sm">
                              검색된 주문이 없습니다.
                          </td>
                      </tr>
                  ) : (
