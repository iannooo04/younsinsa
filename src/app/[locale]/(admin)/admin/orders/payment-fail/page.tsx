              ...
              <div className="space-y-4">
                  <div>
                       ...
                       <div className="pl-0 text-xs text-gray-500 space-y-1">
                           ...
                           <p>· 결제 실패/시도 리스트의 주문상태는 "결제시도, 고객결제중단, 결제실패"로 구분됩니다.</p>
