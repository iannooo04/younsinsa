  ...
  return (
    <div className="p-6 bg-white min-h-screen font-sans text-xs pb-24 relative">
            ...
            <div className="flex items-center text-xs border-b border-gray-200">
             ...
             <div className="flex items-center text-xs">
                ...
                <div className="flex-1 p-3 flex items-center gap-2">
                     <Select defaultValue="purchase_confirm_date">
                        <SelectTrigger className="w-24 h-7 text-[11px] border-gray-300">
                            <SelectValue placeholder="구매확정일" />
                        </SelectTrigger>
                        <SelectContent>
      ...
      <div className="flex mb-4">
          <div className="px-4 py-2 bg-white border border-gray-300 border-b-white text-gray-900 font-bold text-xs cursor-pointer relative top-[1px] z-10 w-32 text-center">
              주문번호별
          </div>
          <div className="px-4 py-2 bg-[#F5F5F5] border border-gray-300 border-l-0 text-gray-500 text-xs cursor-pointer w-32 text-center">
              상품주문번호별
          </div>
          ...
          <table className="w-full text-xs text-center border-collapse table-fixed min-w-[1800px]">
              ...
              <thead className="bg-[#BDBDBD] text-white font-normal">
                  <tr className="h-10">
                      ...
                      <th className="border-r border-[#CDCDCD]">송장번호</th>
                      <th className="border-r border-[#CDCDCD]">사은품</th>
              ...
              <tbody className="text-gray-600 bg-white">
                  <tr>
                      <td colSpan={15} className="py-10 border-b border-gray-200 text-center text-sm">
                          검색된 주문이 없습니다.
                      </td>
                  </tr>
              </tbody>
              ...
              <div className="space-y-4">
                  ...
                  <div>
                       ...
                       <div className="pl-0 text-xs text-gray-500 space-y-1">
                           ...
                           <p className="pl-2">- 입금대기 상태 주문은 구매자가 쇼핑몰 마이페이지에서 직접 취소처리가 가능합니다.<br/>(구매자가 직접 취소처리한 주문은 "취소/교환/반품/환불 관리{'>'}취소 리스트" 메뉴에서 "고객요청취소" 상태로 노출됩니다.)</p>
                           <p className="pl-2">- 배송중, 배송완료 상태 주문은 구매자가 쇼핑몰 마이페이지에서 교환신청 또는 반품신청이 가능하며, 상품준비중 상태 주문은 환불신청이 가능합니다.<br/>(구매자가 "교환/반품/환불신청"한 주문은 "취소/교환/반품/환불 관리{'>'}고객 교환/반품/환불신청 관리" 페이지에서 확인할 수 있으며, <span className="text-red-500 font-bold">운영자는 구매자의 교환/반품/환불신청을 "승인 또는 거절"처리가 가능</span>합니다.)</p>
                       </div>
                  </div>
              </div>
           </div>
