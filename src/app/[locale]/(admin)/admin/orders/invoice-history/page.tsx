  ...
  return (
    <div className="p-6 bg-white min-h-screen font-sans text-xs pb-24 relative">
      <div className="flex items-center justify-between pb-4 border-b border-gray-400 mb-6">
        <h1 className="text-2xl font-bold text-gray-900">발행 내역 리스트</h1>
      </div>
      ...
      <div className="border border-gray-200 mb-8 border-t-2 border-t-gray-500">
        ...
        <div className="flex items-center gap-2 p-3 border-b border-gray-200 bg-[#FBFBFB]">
           <h2 className="font-bold text-gray-700">발행 내역 검색</h2>
        ...
        <div className="p-0">
         ...
         <div className="bg-white p-4 flex flex-col items-center justify-center border-t border-gray-200 gap-2 mb-6">
        ...
        <div className="border-t border-gray-400 mb-6">
             <table className="w-full text-xs text-center border-collapse">
                 <thead className="bg-[#FBFBFB]">
                     <tr className="border-b border-gray-200 h-10 text-gray-700">
                         <th className="font-normal w-1/6">종류</th>
                         <th className="font-normal w-1/6">업체수</th>
                         <th className="font-normal w-1/6">발행수</th>
                         <th className="font-normal w-1/6">발행액</th>
                         <th className="font-normal w-1/6">공급가액</th>
                         <th className="font-normal w-1/6">세액</th>
                     </tr>
                 </thead>
                 <tbody>
                     <tr className="border-b border-gray-200 h-16 text-gray-600">
                         <td className="bg-[#FBFBFB]">일반 세금 계산서</td>
                         <td>0</td>
                         <td>0</td>
                         <td>0</td>
                         <td>0</td>
                      ...
                      <tr className="border-b border-gray-200 h-12 text-gray-600">
                         <td className="bg-[#FBFBFB]">일반 계산서</td>
                         <td>0</td>
                         <td>0</td>
                         <td>0</td>
                         <td>0</td>
                      ...
                      <tr className="border-b border-gray-200 h-16 text-gray-600">
                         <td className="bg-[#FBFBFB]">전자 세금 계산서</td>
                         <td>0</td>
                         <td>0</td>
                         <td>0</td>
                         <td>0</td>
                      ...
                      <tr className="border-b border-gray-200 h-12 text-gray-600">
                         <td className="bg-[#FBFBFB]">전자 계산서</td>
                         <td>0</td>
                         <td>0</td>
                         <td>0</td>
                         <td>0</td>
             ...
             <div className="flex items-center gap-1 mt-2 text-[11px] text-[#999999]">
                 <span className="bg-[#666666] text-white text-[9px] w-3 h-3 flex items-center justify-center rounded-[2px] min-w-[12px]">!</span>
                 전자세금계산서 이용시, 국세청 시스템에서 지원되지 않는 일부 특정문자는 제외되어 전송됩니다. ex)갷, 샇, 랗 등
            </div>
        </div>
      ...
      <div className="bg-[#F8F9FB] border border-gray-300 border-b-0 p-2 flex justify-between items-center">
            <div className="flex gap-1">
             ...
             <div className="flex gap-1">
                 <Select defaultValue="print-select">
                    <SelectTrigger className="w-28 h-7 text-[11px] border-gray-300 bg-white">
                        <SelectValue placeholder="=인쇄 선택=" />
                    </SelectTrigger>
                    <SelectContent>
                        <SelectItem value="print-select">=인쇄 선택=</SelectItem>
                    </SelectContent>
                </Select>
                 <Button variant="outline" className="h-7 px-3 text-[11px] bg-white border-gray-300 text-gray-700 rounded-sm flex items-center gap-1">
      ...
      {/* Table */}
       <div className="border border-gray-300 mb-0 overflow-x-auto">
          <table className="w-full text-xs text-center border-collapse min-w-[1800px]">
               <colgroup>
                  <col className="w-10" />
                  <col className="w-12" />
                  <col className="w-24" />
              ...
              <thead className="bg-[#BDBDBD] text-white font-normal">
                  <tr className="h-10">
                      ...
                      <th className="border-r border-[#CDCDCD] font-normal">종류</th>
                       <th className="border-r border-[#CDCDCD] font-normal">발행상태</th>
                        <th className="border-r border-[#CDCDCD] font-normal">처리일</th>
                      <th className="font-normal">메모</th>
                  </tr>
              </thead>
              <tbody className="bg-white">
                  <tr>
                      <td colSpan={17} className="py-12 border-b border-gray-200 text-center text-gray-500">
                          검색된 정보가 없습니다.
                      </td>
                  </tr>
              </tbody>
       ...
       {/* Bottom Controls */}
       <div className="bg-[#F8F9FB] border border-gray-300 border-t-0 p-2 flex justify-between items-center mb-16">
            <div className="flex gap-1">
                 <Button variant="outline" className="h-7 px-3 text-[11px] bg-white border-gray-300 text-gray-700 rounded-sm">선택 삭제</Button>
            </div>
            <div className="flex gap-1">
