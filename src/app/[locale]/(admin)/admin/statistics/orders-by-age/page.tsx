...
export default function OrdersByAgePage() {
  const [activeTab, setActiveTab] = useState("daily");

  const days = ["2026-01-05", "2026-01-06", "2026-01-07", "2026-01-08", "2026-01-09", "2026-01-10", "2026-01-11"];

  // Helper to render columns for each age group
  const ageGroups = ["10대", "20대", "30대", "40대", "50대", "60대", "70대", "연령미확인"];

  return (
    <div className="p-6 bg-white min-h-screen font-sans text-xs pb-24 relative">
      {/* Header */}
      <h1 className="text-2xl font-bold text-gray-900 mb-4 pb-4 border-b-2 border-gray-800">연령별 주문통계</h1>
      ...
      <div className="mb-12">
        ...
        <div className="border border-gray-300 border-t-0 overflow-x-auto">
           <table className="w-full text-center border-collapse text-xs min-w-[3000px] table-fixed">
            <thead>
               <tr className="bg-[#f5f5f5] text-gray-700 h-10 border-b border-gray-300 font-semibold text-center border-t border-t-gray-400">
                ...
                {ageGroups.map((age, idx) => (
                    <th key={idx} colSpan={4} className="border-r border-gray-300">{age}</th>
                ))}
               </tr>
       ...
       <div className="border-t border-gray-300 pt-6">
        ...
        <div className="space-y-6 text-xs text-gray-600">
          ...
          <div>
            ...
            <ul className="list-none pl-1 space-y-1">
              <li><span className="mr-1">·</span>구매자의 회원가입 시 입력한 생년월일 정보를 기준으로 집계되며, 가입 시 입력한 정보가 없는 경우 "연령미확인" 주문으로 집계됩니다.</li>
