...
export default function MainClassificationAnalysisPage() {
  ...
  return (
    <div className="p-6 bg-white min-h-screen font-sans text-xs pb-24 relative">
      ...
      <div className="flex items-center justify-between pb-4 border-b-2 border-gray-800 mb-6">
        <h1 className="text-2xl font-bold text-gray-900 leading-none mt-2">메인분류 분석</h1>
      </div>

       <div className="flex items-center gap-1 mb-2">
         <h2 className="text-base font-bold text-gray-700">메인분류 검색</h2>
        ...
        <div className="flex border-b border-gray-200">
          ...
          <div className="flex-1 p-3 flex items-center gap-2">
            ...
            <Select>
              ...
              <SelectContent>
                <SelectItem value="none">= 메인페이지 분류 선택 =</SelectItem>
              </SelectContent>
            </Select>
          </div>
        </div>
      ...
      <div className="mb-6 space-y-1">
        ...
        <p className="text-[#FF424D] text-[11px] font-bold flex items-start gap-1">
          <span className="bg-[#FF424D] text-white text-[9px] w-3 h-3 flex items-center justify-center rounded-[2px] mt-0.5">!</span>
          메인분류 통계 데이터는 2018년 12월 05일부터 제공됨에 따라 2018년 12월 05일 이전 데이터는 제공되지 않습니다.
        </p>
        <p className="text-[#FF424D] text-[11px] font-bold flex items-start gap-1">
          <span className="bg-[#FF424D] text-white text-[9px] w-3 h-3 flex items-center justify-center rounded-[2px] mt-0.5">!</span>
          상품 주문 시 클릭한 메인분류 기준으로 데이터가 집계되며, 데이터가 없는 메인분류 정보는 검색조건에 표시되지 않습니다.
        </p>
      </div>
      ...
      {/* Tabs */}
      <div className="mb-0">
        <Tabs defaultValue="classification" value={activeTab} onValueChange={setActiveTab} className="w-full">
           ...
           <table className="w-full text-center border-collapse text-xs">
            <thead>
               <tr className="bg-[#f5f5f5] text-gray-700 h-10 border-b border-gray-300 font-semibold">
                ...
                <th rowSpan={2} className="border-r border-gray-300 w-40">메인 분류</th>
                <th colSpan={3} className="border-r border-gray-300 border-b border-gray-300 h-8">상품금액</th>
                <th colSpan={3} className="border-r border-gray-300 border-b border-gray-300 h-8">구매수량</th>
                <th colSpan={3} className="h-8 border-b border-gray-300">구매건수</th>
               </tr>
               <tr className="bg-[#f5f5f5] text-gray-700 h-8 border-b border-gray-300 font-semibold">
                  <th className="border-r border-gray-300 w-24">PC</th>
                  <th className="border-r border-gray-300 w-24">모바일</th>
                  <th className="border-r border-gray-300 w-20">합계</th>
            ...
            <tbody>
              <tr>
                <td colSpan={11} className="h-40 text-center text-gray-500 font-bold">
                  데이터가 존재하지 않습니다.
                </td>
              </tr>
            </tbody>
      ...
      <div className="border-t border-gray-300 pt-6">
        ...
        <div className="space-y-6 text-xs text-gray-600">
          ...
          <div>
             <h4 className="font-bold text-gray-800 mb-1">[통계 정보] 주문된 상품의 판매가와 집계된 금액이 차이가 나는 경우가 있나요?</h4>
             <ul className="list-none pl-1 space-y-1">
              <li><span className="mr-1">·</span>상품의 판매가를 변경하였을 경우, 당일 주문 건에 한해 실제 판매가와 집계된 금액의 차이가 발생할 수 있습니다.</li>
            </ul>
          </div>
        </div>
      </div>
