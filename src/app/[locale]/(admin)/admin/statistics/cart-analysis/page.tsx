  ...
  return (
    <div className="p-6 bg-white min-h-screen font-sans text-xs pb-24 relative">
      ...
      <div className="flex items-center justify-between pb-4 border-b-2 border-gray-800 mb-6">
        <h1 className="text-2xl font-bold text-gray-900 leading-none mt-2">장바구니 분석</h1>
      </div>

       <div className="flex items-center gap-1 mb-2">
         <h2 className="text-base font-bold text-gray-700">장바구니 검색</h2>
      ...
      <div className="border-t border-gray-400 mb-6">
        ...
        <div className="flex border-b border-gray-200">
          ...
          <div className="flex-1 p-3 flex items-center gap-6">
            <RadioGroup defaultValue="all" className="flex items-center gap-6">
              <div className="flex items-center gap-2">
                <RadioGroupItem value="all" id="purchase-all" className="text-red-500 border-gray-300" />
                <Label htmlFor="purchase-all" className="font-normal cursor-pointer">전체</Label>
              </div>
              <div className="flex items-center gap-2">
                <RadioGroupItem value="yes" id="purchase-yes" className="text-red-500 border-gray-300" />
                <Label htmlFor="purchase-yes" className="font-normal cursor-pointer">구매함</Label>
              </div>
              <div className="flex items-center gap-2">
                <RadioGroupItem value="no" id="purchase-no" className="text-red-500 border-gray-300" />
                <Label htmlFor="purchase-no" className="font-normal cursor-pointer">구매안함</Label>
              </div>
            </RadioGroup>
          </div>
        </div>
           ...
           <table className="w-full text-center border-collapse text-xs">
            <thead>
               <tr className="bg-[#f5f5f5] text-gray-700 h-10 border-b border-gray-300 font-semibold text-center">
                ...
                <th className="border-r border-gray-300 w-40">고객수(회원/비회원)</th>
                <th className="border-r border-gray-300 w-32">이미지</th>
                <th className="border-r border-gray-300">상품명</th>
                <th className="border-r border-gray-300 w-32">가격</th>
                <th className="border-r border-gray-300 w-32">재고</th>
      ...
      <div className="border-t border-gray-300 pt-6">
        ...
        <div className="space-y-6 text-xs text-gray-600">
          <div>
            <h4 className="font-bold text-gray-800 mb-1">[통계 정보] 장바구니 분석의 기준은 무엇인가요?</h4>
            <ul className="list-none pl-1 space-y-1">
              <li><span className="mr-1">·</span>장바구니 분석은 조회기간 동안 장바구니에 담긴 상품의 데이터 수치가 집계됩니다.</li>
              <li><span className="mr-1">·</span>조회기간 동안 장바구니에 담긴 내역이 없는 상품의 데이터는 집계되지 않습니다.</li>
              <li className="text-[#FF424D] mt-1"><span className="mr-1">·</span>장바구니에 담긴 상품은 장바구니에서 삭제되기 전까지 일별 데이터 수치에 반복적으로 집계됩니다.</li>
            </ul>
          </div>
          <div>
