...
export default function SalesByAgePage() {
  ...
  return (
    <div className="p-6 bg-white min-h-screen font-sans text-xs pb-24 relative">
      ...
      <div className="flex items-center justify-between pb-4 border-b-2 border-gray-800 mb-6">
        <h1 className="text-2xl font-bold text-gray-900 leading-none mt-2">연령별 매출통계</h1>
      ...
      <div className="flex border border-gray-300 mb-8 bg-[#F3F6F9]/50">
          <div className="w-[15%] flex flex-col items-center justify-center p-6 border-r border-gray-300 bg-[#E5EEF6]/50">
              <h3 className="text-gray-600 font-bold mb-4">총 매출금액</h3>
              <div className="text-xl font-normal text-gray-800">0원</div>
          </div>
          <div className="flex-1 grid grid-cols-4 divide-x divide-y border-t-0 border-b-0 divide-gray-300">
              <AgeSummary age="10대" value="0원" />
              <AgeSummary age="20대" value="0원" />
              <AgeSummary age="30대" value="0원" />
              <AgeSummary age="40대" value="0원" />
              <AgeSummary age="50대" value="0원" />
              <AgeSummary age="60대" value="0원" />
              <AgeSummary age="70대" value="0원" />
              <AgeSummary age="연령미확인" value="0원" />
          </div>
      </div>
      ...
      <div className="mb-12">
           ...
           <table className="w-full text-center border-collapse text-xs min-w-[1000px]">
            <thead>
               <tr className="bg-[#f5f5f5] text-gray-700 h-10 border-b border-gray-300 font-semibold text-center border-t border-t-gray-400">
                ...
                <th className="border-r border-gray-300">10대</th>
                <th className="border-r border-gray-300">20대</th>
                <th className="border-r border-gray-300">30대</th>
                <th className="border-r border-gray-300">40대</th>
                <th className="border-r border-gray-300">50대</th>
                <th className="border-r border-gray-300">60대</th>
                <th className="border-r border-gray-300">70대</th>
                <th className="">연령미확인</th>
               </tr>
            </thead>
            <tbody>
                {days.map((date) => (
       ...
       <div className="border-t border-gray-300 pt-6">
        ...
        <div className="space-y-6 text-xs text-gray-600">
          ...
          <div>
            <h4 className="font-bold text-gray-800 mb-1">[통계 정보] 연령대의 기준은 무엇인가요?</h4>
            <ul className="list-none pl-1 space-y-1">
              <li><span className="mr-1">·</span>연령대 정보는 구매자의 회원가입 시 입력한 생년월일 정보를 기준으로 집계되며, 가입 시 입력한 정보가 없는 경우 "연령미확인" 매출로 집계됩니다.</li>
              <li><span className="mr-1">·</span>가입 후 정보를 수정한 경우 해당 수정일에 변경된 정보가 적용되어 집계되며, 기존 통계 데이터는 변경되지 않습니다.</li>
              <li><span className="mr-1">·</span>생년월일 기준 10대 미만인 경우 10대 회원으로, 70대 이상인 경우 70대 회원에 포함되어 데이터가 집계됩니다.</li>
            </ul>
          </div>
           ...
           <div>
             ...
             <ul className="list-none pl-1 space-y-1">
              ...
              <li><span className="mr-1">·</span>환불금액 = 상품결제금액 + 배송비결제금액</li>
               ...
               <li><span className="mr-1">·</span>배송비결제금액 = 배송비 - 배송비 - 배송비할인</li>
            </ul>
          </div>
...
function AgeSummary({ age, value }: { age: string; value: string }) {
    return (
        <div className="flex flex-col items-center justify-center p-4 bg-white">
            <h3 className="text-gray-600 mb-4">{age}</h3>
