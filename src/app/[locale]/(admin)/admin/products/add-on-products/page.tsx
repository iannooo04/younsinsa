  ...
  return (
    <div className="p-6 bg-white min-h-screen font-sans text-xs pb-24 relative">
      ...
      <div className="flex items-center justify-between pb-4 border-b border-gray-400 mb-6">
        <h1 className="text-2xl font-bold text-gray-900">추가상품 관리</h1>
        <Button
          variant="outline"
      ...
      <div className="border-t-2 border-gray-500 border-b border-gray-200 mb-8 border-l border-r">
        <div className="flex items-center gap-2 p-3 border-b border-gray-200 bg-[#FBFBFB]">
           <h2 className="font-bold text-gray-700">추가상품 검색</h2>
        ...
        <div className="p-0">
            ...
            <div className="p-3 bg-white">
                ...
                >
                    상세검색 펼침 
                    <ChevronDown className={`w-3 h-3 ml-1 transform transition-transform ${isDetailSearchOpen ? 'rotate-180' : ''}`} />
                </button>
            </div>
          ...
          <table className="w-full text-xs text-center border-collapse table-fixed min-w-[1200px]">
              ...
              <thead className="bg-[#BDBDBD] text-white font-normal">
                  <tr>
                      ...
                      <th className="py-2.5 border-r border-[#CDCDCD]">이미지</th>
                      <th className="py-2.5 border-r border-[#CDCDCD]">상품명</th>
                      <th className="py-2.5 border-r border-[#CDCDCD]">옵션</th>
                      <th className="py-2.5 border-r border-[#CDCDCD]">판매가</th>
                      <th className="py-2.5 border-r border-[#CDCDCD]">공급사</th>
                      <th className="py-2.5 border-r border-[#CDCDCD]">승인상태</th>
                      <th className="py-2.5 border-r border-[#CDCDCD]">노출상태</th>
                      <th className="py-2.5 border-r border-[#CDCDCD]">재고</th>
      ...
      <div className="flex justify-between items-center bg-[#F9F9F9] p-3 border-t border-b border-gray-200 mb-10">
          <div className="flex gap-1">
               ...
               <Button variant="outline" size="sm" className="h-8 text-xs bg-white border-gray-300 hover:bg-gray-50 text-gray-700 rounded-sm shadow-sm px-3 font-normal">상품 필수정보 설정</Button>
          </div>
          <div>
               <Button variant="outline" size="sm" className="h-8 text-xs bg-white border-gray-300 hover:bg-gray-50 text-green-600 text-green-600 rounded-sm shadow-sm px-3 font-bold flex items-center gap-1">
       ...
       <div className="mt-8">
            ...
            <div className="text-xs space-y-3 text-gray-600 border-t border-gray-200 pt-3">
               <div>
                   ...
                   <p>· 추가상품 리스트 내 운영자가 선택한 추가상품을 "상품코드"만 다르게 추가 생성됩니다.</p>
                   <p>· 복사된 추가상품은 기존 추가상품과 "상품코드" 외 모든 정보가 동일하게 복사됩니다.</p>
               </div>
               
               <div>
                   <h3 className="font-bold text-gray-800 mb-1">[추가상품 정보] 선택 삭제는 무엇인가요?</h3>
                   <p>· 추가상품 리스트 내 운영자가 선택한 추가상품을 삭제처리 합니다.</p>
                   <p className="text-red-500 font-bold">- 삭제된 정보는 복구가 불가능하므로 삭제 시 유의하시기 바랍니다.</p>
               </div>

                <div>
                   <h3 className="font-bold text-gray-800 mb-1">[추가상품 정보] 상품 수정은 어떻게 하나요?</h3>
                   <p>· 추가상품 수정 페이지는 추가상품 리스트 내 [수정] 버튼 클릭 시 현재창으로 노출되고, 상품명 클릭 시 새창으로 노출됩니다.</p>
                   <p>· 추가상품 정보는 "상품코드" 외 모든 정보를 수정할 수 있습니다.</p>
               </div>
            </div>
       </div>
