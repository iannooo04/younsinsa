...
export default function MileageGiveDeductPage() {
  return (
    <div className="p-6 bg-white min-h-screen font-sans text-xs pb-24 relative">
       {/* Header */}
      <div className="flex items-center justify-between pb-4 border-b-2 border-gray-800 mb-6">
        <h1 className="text-2xl font-bold text-gray-900 leading-none mt-2">마일리지 지급/차감</h1>
        <Button variant="outline" className="h-9 px-4 text-xs bg-white text-red-500 border-red-500 hover:bg-red-50 font-bold rounded-[2px] flex items-center gap-1">
             <span className="text-lg leading-none pb-0.5">+</span> 마일리지 지급/차감
        </Button>
      </div>
      ...
      <div className="mb-0">
        <div className="flex items-center gap-2 mb-2">
           <h2 className="font-bold text-base text-gray-800">마일리지 지급/차감내역 검색</h2>
       ...
       <div className="mb-0">
           <Tabs defaultValue="general" className="w-full">
                <TabsList className="bg-transparent p-0 justify-start gap-0 h-9 mb-2 border-b border-gray-400 w-full rounded-none">
                     <TabsTrigger 
                        value="general" 
                        className="rounded-none border-t border-l border-r border-gray-300 bg-white data-[state=active]:bg-white data-[state=active]:border-gray-400 data-[state=active]:border-b-white data-[state=active]:text-gray-900 text-gray-500 h-9 px-6 font-bold text-xs relative top-[1px]"
                    >
                        일반 회원
                    </TabsTrigger>
                     <TabsTrigger 
                        value="withdrawn" 
                        className="rounded-none border-t border-r border-gray-300 bg-[#F9F9F9] data-[state=active]:bg-white data-[state=active]:border-gray-400 data-[state=active]:border-l data-[state=active]:border-b-white data-[state=active]:text-gray-900 text-gray-500 h-9 px-6 font-normal text-xs relative top-[1px]"
                    >
                        탈퇴 회원
                    </TabsTrigger>
                </TabsList>
                ...
                <table className="w-full text-xs text-center border-collapse">
                     <thead>
                         <tr className="bg-[#B9B9B9] text-white h-9 border-b border-gray-300 font-normal">
                             ...
                             <th className="w-32 border-r border-gray-300">소멸예정일</th>
