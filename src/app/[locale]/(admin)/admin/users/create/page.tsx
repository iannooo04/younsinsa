        ...
        <div className="border-t border-gray-400 border-b border-gray-200">
             ...
             <div className="flex border-b border-gray-200">
                ...
                <div className="flex-1 p-3 flex items-center gap-6">
                    <RadioGroup defaultValue="personal" className="flex items-center gap-6">
             ...
             <div className="flex border-b border-gray-200">
                ...
                <div className="flex-1 p-3 flex items-center gap-6">
                     <RadioGroup defaultValue="approved" className="flex items-center gap-6">
                         <div className="flex items-center gap-1.5">
             ...
             {/* ID / Nickname (Split row) */}
             <div className="flex border-b border-gray-200">
                <div className="w-40 bg-[#FBFBFB] p-3 pl-4 font-bold text-gray-700 flex items-center">
                    <span className="text-red-500 mr-1">*</span> 아이디
                </div>
                <div className="flex-1 p-3 border-r border-gray-200 flex items-center gap-1">
                    <Input className="w-48 h-7 border-red-300 focus:border-red-500 focus:ring-red-200 bg-red-50/10 text-xs" />
                    <Button variant="secondary" className="h-7 px-3 text-[11px] bg-[#999999] text-white rounded-[2px] hover:bg-[#888888]">중복확인</Button>
                </div>
                 <div className="w-40 bg-[#FBFBFB] p-3 pl-4 font-bold text-gray-700 flex items-center">
                    닉네임
                </div>
            ...
            {/* Name / Password */}
             <div className="flex border-b border-gray-200">
                ...
                <div className="flex-1 p-3 border-r border-gray-200">
                    <Input className="w-48 h-7 border-gray-300 text-xs" />
                </div>
                 <div className="w-40 bg-[#FBFBFB] p-3 pl-4 font-bold text-gray-700 flex items-center">
                ...
                <div className="flex-1 p-3">
                     <div className="flex flex-col gap-1">
                        <div className="flex items-center gap-1">
                            <Input className="w-48 h-7 border-gray-300 text-xs" placeholder="비밀번호 입력" />
                            <span className="text-[11px] text-red-500">0 / 16</span>
                        </div>
                        <div className="flex items-center gap-1">
                            <Input className="w-48 h-7 border-gray-300 text-xs" placeholder="비밀번호 확인" />
                            <span className="text-[11px] text-red-500">0 / 16</span>
                        </div>
             ...
             <div className="flex border-b border-gray-200">
                ...
                <div className="flex-[2] p-3 border-r border-gray-200">
                    <div className="flex items-center gap-1 mb-2">
                        <Input className="w-32 h-7 border-gray-300 text-xs" />
                        <span className="text-gray-500">@</span>
                         <Input className="w-32 h-7 border-red-300 bg-red-50/10 text-xs" />
                    ...
                    <div className="flex items-center gap-1.5 mb-2">
                         <Checkbox id="mail-consent" className="border-gray-300 rounded-[2px]" />
        ...
        <div className="border-t border-gray-400 border-b border-gray-200">
            {/* Fax / Job */}
             ...
             <div className="flex border-b border-gray-200">
                ...
                <div className="flex-1 p-3 border-r border-gray-200 flex items-center gap-1">
                     <Input className="w-48 h-7 border-red-300 focus:border-red-500 focus:ring-red-200 bg-red-50/10 text-xs" />
                     <Button variant="secondary" className="h-7 px-3 text-[11px] bg-[#999999] text-white rounded-[2px] hover:bg-[#888888]">확인</Button>
                </div>
                 <div className="w-40 bg-[#FBFBFB] p-3 pl-4 font-bold text-gray-700 flex items-center">
                    추천받은횟수
                </div>
            ...
            <div className="flex border-b border-gray-200">
                ...
                <div className="flex-1 p-3 grid grid-cols-5 gap-y-2">
                     {["화장품/향수/미용품", "컴퓨터/SW", "의류/패션잡화", "생활/주방용품", "보석/시계/악세사리", "가전/카메라", "서적/음반/비디오"].map((item, idx) => (
                        <div key={idx} className="flex items-center gap-1.5">
                            <Checkbox id={`interest-${idx}`} className="border-gray-300 rounded-[2px]" />
             ...
             <div className="flex border-b border-gray-200">
                ...
                <div className="flex-1 p-3 flex items-center gap-6">
                    <RadioGroup defaultValue="1y" className="flex items-center gap-6">
                        <div className="flex items-center gap-1.5">
                        ...
                        <div className="flex items-center gap-1.5">
                            <RadioGroupItem value="until" id="retain-until" className="border-gray-300 text-gray-600" />
             ...
             <div className="flex border-b border-gray-200">
                ...
                <div className="flex-1 p-3">
                     <Textarea className="w-full h-32 resize-none border-gray-300 text-xs" />
                </div>
            </div>
        </div>
      </div>
