                ...
                <div>
                    ...
                    <div className="border border-t-0 border-gray-300 text-xs text-gray-700 border-l-0 border-r-0">
                        ...
                        <div className="flex border-b border-gray-200 min-h-[50px]">
                            ...
                            <div className="flex-1 p-3 flex items-center text-gray-800">
                                E0000001
                            </div>
                        </div>
                         {/* Theme Name */}
                        <div className="flex border-b border-gray-200 min-h-[50px]">
                            ...
                            <div className="flex-1 p-3 flex items-center gap-2">
                                <div className="relative">
                                     <Input className="w-[300px] h-8 text-xs pr-10 rounded-sm border-gray-300" defaultValue="카테고리테마" />
                                     <span className="absolute right-2 top-2 text-[10px] text-red-500 font-bold">6 / 60</span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="flex-1 p-3 flex items-center gap-4 flex-wrap">
                                {['이미지', '대표색상', '브랜드', '제조사', '상품명', '짧은설명', '정가', '판매가', '할인적용가', '쿠폰가', '상품할인금액', '마일리지', '모델번호', '상품코드'].map((item, idx) => (
                                    <label key={idx} className="flex items-center gap-1 cursor-pointer">
                                        <input type="checkbox" className="rounded-sm border-gray-300 w-4 h-4 checked:bg-red-500 checked:border-red-500" defaultChecked={['이미지', '상품명', '판매가'].includes(item)} />
                                        <span>{item}</span>
                                    </label>
                                ))}
                            </div>
