...
export default function MobileSecurityServerPage() {
    return (
        <div className="p-6 space-y-8 bg-white min-h-screen font-sans text-sm pb-24">
            {/* Header */}
            <div className="flex items-center justify-between pb-4 border-b border-gray-300">
                <h1 className="text-2xl font-bold text-gray-900">모바일쇼핑몰 보안서버 관리</h1>
            ...
            <div className="space-y-4">
                <div className="flex items-center gap-2">
                    <h2 className="text-lg font-bold text-gray-800">모바일쇼핑몰 보안서버 관리</h2>
                ...
                <div className="space-y-1 text-xs text-gray-500">
                     <div className="flex items-start gap-1">
                        ...
                        <p>
                             보안서버 설정은 <span className="text-gray-900 font-bold">마이페이지 &gt; 도메인 연결</span>에서 연결한 도메인 별로 사용 설정이 가능합니다.
                        </p>
                    </div>
                    <div className="flex items-start gap-1">
                        <span className="bg-gray-600 text-white text-[10px] px-1 rounded-[2px] mt-0.5 font-bold shrink-0">!</span>
                    ...
                    <div className="flex items-start gap-1">
                        <span className="bg-gray-600 text-white text-[10px] px-1 rounded-[2px] mt-0.5 font-bold shrink-0">!</span>
                        <p>
                            PC쇼핑몰과 모바일쇼핑몰 보안서버는 별도로 적용하셔야 합니다. PC쇼핑몰 보안서버 관리 <Link href="#" className="font-bold underline">바로가기 &gt;</Link>
                        </p>
                    </div>
                    <div className="flex items-start gap-1">
                        <span className="bg-gray-600 text-white text-[10px] px-1 rounded-[2px] mt-0.5 font-bold shrink-0">!</span>
