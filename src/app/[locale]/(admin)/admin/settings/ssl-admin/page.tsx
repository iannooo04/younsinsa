...
export default function AdminSecurityServerPage() {
    return (
        <div className="p-6 space-y-8 bg-white min-h-screen font-sans text-sm pb-24">
            {/* Header */}
            <div className="flex items-center justify-between pb-4 border-b border-gray-300">
                <h1 className="text-2xl font-bold text-gray-900">관리자 보안서버 관리</h1>
            ...
            <div className="space-y-4">
                <div className="flex items-center gap-2">
                    <h2 className="text-lg font-bold text-gray-800">관리자 보안서버 관리</h2>
                ...
                <div className="space-y-1 text-xs text-gray-500">
                     <div className="flex items-start gap-1">
                        <span className="bg-gray-600 text-white text-[10px] px-1 rounded-[2px] mt-0.5 font-bold">!</span>
                        <p>
                            관리자 보안서버는 <span className="text-gray-900 font-bold">마이페이지 &gt; 도메인 연결</span>에서 연결한 대표도메인에만 설정이 가능합니다.
                        </p>
                    </div>
                    <div className="flex items-start gap-1">
                        <span className="bg-gray-600 text-white text-[10px] px-1 rounded-[2px] mt-0.5 font-bold">!</span>
